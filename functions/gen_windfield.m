function wind = gen_windfield(Ua,Ti,d,Lx,Ly,SimTime,Ts,desc)
% 
...
wind.input = struct('Ua',Ua,'Ti',Ti,'d',d,'Lx',Lx,'Ly',Ly,'SimTime',SimTime,'Ts',Ts,'desc',desc);
